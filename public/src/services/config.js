...
const DEFAULT_CLOUD_RUN_BACKEND_URL = 'https://scnu--hackathon-studymate-git-uvzg7g7b2q-du.a.run.app';

export function getBackendBaseUrl() {
  if (typeof window === 'undefined') return DEFAULT_CLOUD_RUN_BACKEND_URL;
